...
def main():
    ...
    # deposit(address of the asset, amount, account address, always pass 0 (deplicated))
    print("Depositing...")
...
# amount: the amount of tokens we allow the spender to spend
# spender: spender of the our token
# erc20_address: address of the token
# account: our account
